...
Revision ID: d1ca42754df4
Revises: 
Create Date: 2025-06-05 16:05:43.815105
...
def upgrade():
    ...
    sa.Column('categoria', sa.Enum('General', 'Especializado', 'Clínica', 'Emergencias', name='hospital_categoria_enum'), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('nombre')
    )
    op.create_table('roles',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('nombre', sa.Enum('SUPERADMIN', 'ADMINISTRADOR', 'CONDUCTOR', 'ENFERMERO', 'PARAMEDICO', name='roles_enum'), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('nombre')
    )
    ...
    sa.Column('categoria_ambulancia', sa.Enum('BASICA', 'MEDICALIZADA', 'UTIM', name='categoria_ambulancia_enum'), nullable=False),
    ...
    sa.Column('personal_rol', sa.Enum('SUPERADMIN', 'ADMINISTRADOR', 'CONDUCTOR', 'ENFERMERO', 'PARAMEDICO', name='roles_enum'), nullable=True),
    ...
    sa.Column('genero', sa.Enum('MASCULINO', 'FEMENINO', 'OTRO', name='genero_enum'), nullable=False),
    ...
    sa.Column('estado', sa.Enum('LEVE', 'MODERADO', 'GRAVE', 'CRITICO', name='estado_accidente_enum'), nullable=False),
